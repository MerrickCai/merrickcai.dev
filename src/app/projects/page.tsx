      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-2">
            {/* NexusHeart Project */}
            <div className="group relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-800/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
              ...
              <div className="relative">
                ...
                <Link
                  ...
                  className="group/link inline-flex items-center rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 font-semibold text-white transition-all hover:from-purple-700 hover:to-pink-700 hover:scale-105"
                >
                  Visit Live Site
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-800/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
              ...
              <div className="relative">
                ...
                <Link
                  href="/"
                  className="group/link inline-flex items-center rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 font-semibold text-white transition-all hover:from-blue-700 hover:to-indigo-700 hover:scale-105"
                >
                  View Current Site
          ...
          {/* Coming Soon Section */}
          <div className="mt-12">
            <div className="group relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-800/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl text-center">
              ...
              <div className="relative">
                ...
                <Link
                  href="/contact"
                  className="group/cta inline-flex items-center rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-4 text-lg font-semibold text-white transition-all hover:from-violet-700 hover:to-purple-700 hover:scale-105"
                >
