            ...
            <div className="lg:col-span-2">
              <div className="group relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-800/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center rounded-lg bg-blue-50 dark:bg-blue-900/20 p-4 text-blue-700 dark:text-blue-300">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        <span
                          key={skill}
                          className="rounded-full bg-blue-100 dark:bg-blue-900/30 px-4 py-2 text-sm font-medium text-blue-800 dark:text-blue-200 transition-all hover:scale-105"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["Node.js", "Express", "Supabase", "REST API", "JWT Authentication"].map((skill) => (
                        <span
                          key={skill}
                          className="rounded-full bg-green-100 dark:bg-green-900/30 px-4 py-2 text-sm font-medium text-green-800 dark:text-green-200 transition-all hover:scale-105"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["Vite", "Vercel", "Git & GitHub Actions"].map((skill) => (
                        <span
                          key={skill}
                          className="rounded-full bg-purple-100 dark:bg-purple-900/30 px-4 py-2 text-sm font-medium text-purple-800 dark:text-purple-200 transition-all hover:scale-105"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["C", "C++", "Data Structures", "Algorithms", "Operating Systems"].map((skill) => (
                        <span
                          key={skill}
                          className="rounded-full bg-orange-100 dark:bg-orange-900/30 px-4 py-2 text-sm font-medium text-orange-800 dark:text-orange-200 transition-all hover:scale-105"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["Responsive Design", "Flexbox", "Animation", "Accessibility"].map((skill) => (
                        <span
                          key={skill}
                          className="rounded-full bg-pink-100 dark:bg-pink-900/30 px-4 py-2 text-sm font-medium text-pink-800 dark:text-pink-200 transition-all hover:scale-105"
                        >
                          {skill}
                        </span>
                      ))}
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-800/80 p-8 shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="relative">
                ...
                <div className="rounded-2xl border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20 p-6">
                ...
                <div className="mt-6 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 p-12 shadow-2xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/contact"
                className="group inline-flex items-center justify-center rounded-xl bg-white px-8 py-4 text-lg font-semibold text-blue-600 transition-all duration-200 hover:bg-gray-100 hover:scale-105"
              >
              ...
              <Link
                href="/projects"
                className="group inline-flex items-center justify-center rounded-xl border-2 border-white px-8 py-4 text-lg font-semibold text-white transition-all duration-200 hover:bg-white hover:text-blue-600 hover:scale-105"
              >
